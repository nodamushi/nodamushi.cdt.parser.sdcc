...
public class SDCCExpressionParser extends PrsStream implements RuleAction, ITokenStream, 
                                                       ITokenCollector, IParser< IASTExpression > 
                                                        , ISecondaryParser< IASTExpression >   
{
    private static ParseTable prs = new SDCCExpressionParserprs();
    ...
    public SDCCExpressionParser(LexStream lexStream)
    {
        super(lexStream);

        try
        {
            super.remapTerminalSymbols(orderedTerminalSymbols(), SDCCExpressionParserprs.EOFT_SYMBOL);
        }
        ...
        catch(UnimplementedTerminalsException e)
        {
            ...
            for (int i = 0; i < unimplemented_symbols.size(); i++)
            {
                ...
                System.out.println("    " + SDCCExpressionParsersym.orderedTerminalSymbols[id.intValue()]);               
            }
            System.out.println();                        
        }
        catch(UndefinedEofSymbolException e)
        {
            throw new Error(new UndefinedEofSymbolException
                                ("The Lexer does not implement the Eof symbol " +
                                 SDCCExpressionParsersym.orderedTerminalSymbols[SDCCExpressionParserprs.EOFT_SYMBOL]));
        } 
    }

    public String[] orderedTerminalSymbols() { return SDCCExpressionParsersym.orderedTerminalSymbols; }
    public String getTokenKindName(int kind) { return SDCCExpressionParsersym.orderedTerminalSymbols[kind]; }
    public int getEOFTokenKind() { return SDCCExpressionParserprs.EOFT_SYMBOL; }
    ...
    public void parser(Monitor monitor, int error_repair_count)
    {
        ...
        catch (NotBacktrackParseTableException e)
        {
            throw new Error(new NotBacktrackParseTableException
                                ("Regenerate SDCCExpressionParserprs.java with -BACKTRACK option"));
        }
        catch (BadParseSymFileException e)
        {
            throw new Error(new BadParseSymFileException("Bad Parser Symbol File -- SDCCExpressionParsersym.java"));
        }
...
public SDCCExpressionParser(IScanner scanner, IDOMTokenMap tokenMap, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String,String> properties) {
...
public String[] getOrderedTerminalSymbols() {
	return SDCCExpressionParsersym.orderedTerminalSymbols;
}

@SuppressWarnings("nls")
public String getName() {
	return "SDCCExpressionParser";
}
...
public void setTokens(List<IToken> tokens) {
	...
	addToken(new Token(null, 0, 0, SDCCExpressionParsersym.TK_EOF_TOKEN));
}

public SDCCExpressionParser(ITokenStream stream, Map<String,String> properties) {  // constructor for creating secondary parser
	initActions(properties);
	tokenMap = new TokenMap(SDCCExpressionParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
}	
    ...
    public void ruleAction(int ruleNumber)
    {
        switch (ruleNumber)
        {
          ...
          break;
            ...
            //
            // Rule 320:  type_qualifier ::= sdcc_type_qualifier
            //
            case 320: {
          ...
          break;
            ...
            //
            // Rule 334:  define_address ::= __at absolute_address
            //
            case 334: {
                  action.   consumeDefineAddress();    
          break;
          ...
          break;
            ...
            //
            // Rule 337:  original_function_direct_declarator ::= basic_direct_declarator ( <openscope-ast> parameter_type_list )
            //
            case 337: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, true);    
          break;
            ...
            //
            // Rule 338:  original_function_direct_declarator ::= basic_direct_declarator ( )
            //
            case 338: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, false);    
          break;
            ...
            //
            // Rule 339:  function_direct_declarator ::= original_function_direct_declarator <openscope-ast> sdcc_function_attributes
            //
            case 339: {
          ...
          break;
            ...
            //
            // Rule 343:  sdcc_function_attribute ::= __critical
            //
            case 343: {
          ...
          break;
            ...
            //
            // Rule 344:  sdcc_function_attribute ::= __reentrant
            //
            case 344: {
          ...
          break;
            ...
            //
            // Rule 345:  sdcc_function_attribute ::= __naked
            //
            case 345: {
          ...
          break;
            ...
            //
            // Rule 346:  sdcc_function_attribute ::= __shadowregs
            //
            case 346: {
          ...
          break;
            ...
            //
            // Rule 347:  sdcc_function_attribute ::= __wparam
            //
            case 347: {
          ...
          break;
            ...
            //
            // Rule 353:  address_function_attribute ::= __interrupt
            //
            case 353: {
          ...
          break;
            ...
            //
            // Rule 354:  address_function_attribute ::= __using
            //
            case 354: {
