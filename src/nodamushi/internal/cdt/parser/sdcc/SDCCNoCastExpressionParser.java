...
public class SDCCNoCastExpressionParser extends PrsStream implements RuleAction, ITokenStream, 
                                                       ITokenCollector, IParser< IASTExpression > 
                                                        , ISecondaryParser< IASTExpression >   
{
    private static ParseTable prs = new SDCCNoCastExpressionParserprs();
    ...
    public SDCCNoCastExpressionParser(LexStream lexStream)
    {
        super(lexStream);

        try
        {
            super.remapTerminalSymbols(orderedTerminalSymbols(), SDCCNoCastExpressionParserprs.EOFT_SYMBOL);
        }
        ...
        catch(UnimplementedTerminalsException e)
        {
            ...
            for (int i = 0; i < unimplemented_symbols.size(); i++)
            {
                ...
                System.out.println("    " + SDCCNoCastExpressionParsersym.orderedTerminalSymbols[id.intValue()]);               
            }
            System.out.println();                        
        }
        catch(UndefinedEofSymbolException e)
        {
            throw new Error(new UndefinedEofSymbolException
                                ("The Lexer does not implement the Eof symbol " +
                                 SDCCNoCastExpressionParsersym.orderedTerminalSymbols[SDCCNoCastExpressionParserprs.EOFT_SYMBOL]));
        } 
    }

    public String[] orderedTerminalSymbols() { return SDCCNoCastExpressionParsersym.orderedTerminalSymbols; }
    public String getTokenKindName(int kind) { return SDCCNoCastExpressionParsersym.orderedTerminalSymbols[kind]; }
    public int getEOFTokenKind() { return SDCCNoCastExpressionParserprs.EOFT_SYMBOL; }
    ...
    public void parser(Monitor monitor, int error_repair_count)
    {
        ...
        catch (NotBacktrackParseTableException e)
        {
            throw new Error(new NotBacktrackParseTableException
                                ("Regenerate SDCCNoCastExpressionParserprs.java with -BACKTRACK option"));
        }
        catch (BadParseSymFileException e)
        {
            throw new Error(new BadParseSymFileException("Bad Parser Symbol File -- SDCCNoCastExpressionParsersym.java"));
        }
...
public SDCCNoCastExpressionParser(IScanner scanner, IDOMTokenMap tokenMap, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String,String> properties) {
...
public String[] getOrderedTerminalSymbols() {
	return SDCCNoCastExpressionParsersym.orderedTerminalSymbols;
}

@SuppressWarnings("nls")
public String getName() {
	return "SDCCNoCastExpressionParser";
}
...
public void setTokens(List<IToken> tokens) {
	...
	addToken(new Token(null, 0, 0, SDCCNoCastExpressionParsersym.TK_EOF_TOKEN));
}

public SDCCNoCastExpressionParser(ITokenStream stream, Map<String,String> properties) {  // constructor for creating secondary parser
	initActions(properties);
	tokenMap = new TokenMap(SDCCNoCastExpressionParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
}	
