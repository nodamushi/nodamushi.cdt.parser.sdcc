...
public class SDCCParser extends PrsStream implements RuleAction, ITokenStream, 
                                                       ITokenCollector, IParser< IASTTranslationUnit  > 
                                                           
{
    private static ParseTable prs = new SDCCParserprs();
    ...
    public SDCCParser(LexStream lexStream)
    {
        super(lexStream);

        try
        {
            super.remapTerminalSymbols(orderedTerminalSymbols(), SDCCParserprs.EOFT_SYMBOL);
        }
        ...
        catch(UnimplementedTerminalsException e)
        {
            ...
            for (int i = 0; i < unimplemented_symbols.size(); i++)
            {
                ...
                System.out.println("    " + SDCCParsersym.orderedTerminalSymbols[id.intValue()]);               
            }
            System.out.println();                        
        }
        catch(UndefinedEofSymbolException e)
        {
            throw new Error(new UndefinedEofSymbolException
                                ("The Lexer does not implement the Eof symbol " +
                                 SDCCParsersym.orderedTerminalSymbols[SDCCParserprs.EOFT_SYMBOL]));
        } 
    }

    public String[] orderedTerminalSymbols() { return SDCCParsersym.orderedTerminalSymbols; }
    public String getTokenKindName(int kind) { return SDCCParsersym.orderedTerminalSymbols[kind]; }
    public int getEOFTokenKind() { return SDCCParserprs.EOFT_SYMBOL; }
    ...
    public void parser(Monitor monitor, int error_repair_count)
    {
        ...
        catch (NotBacktrackParseTableException e)
        {
            throw new Error(new NotBacktrackParseTableException
                                ("Regenerate SDCCParserprs.java with -BACKTRACK option"));
        }
        catch (BadParseSymFileException e)
        {
            throw new Error(new BadParseSymFileException("Bad Parser Symbol File -- SDCCParsersym.java"));
        }
...
public SDCCParser(IScanner scanner, IDOMTokenMap tokenMap, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String,String> properties) {
...
public String[] getOrderedTerminalSymbols() {
	return SDCCParsersym.orderedTerminalSymbols;
}
    ...
    public void ruleAction(int ruleNumber)
    {
        switch (ruleNumber)
        {
          ...
          break;
            ...
            //
            // Rule 318:  type_qualifier ::= sdcc_type_qualifier
            //
            case 318: {
          ...
          break;
            ...
            //
            // Rule 331:  define_address ::= __at ( absolute_address )
            //
            case 331: {
          ...
          break;
            ...
            //
            // Rule 335:  original_function_direct_declarator ::= basic_direct_declarator ( <openscope-ast> parameter_type_list )
            //
            case 335: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, true);    
          break;
            ...
            //
            // Rule 336:  original_function_direct_declarator ::= basic_direct_declarator ( )
            //
            case 336: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, false);    
          break;
            ...
            //
            // Rule 337:  function_direct_declarator ::= original_function_direct_declarator <openscope-ast> sdcc_function_attributes
            //
            case 337: {
          ...
          break;
            ...
            //
            // Rule 341:  sdcc_function_attribute ::= __critical
            //
            case 341: {
          ...
          break;
            ...
            //
            // Rule 342:  sdcc_function_attribute ::= __reentrant
            //
            case 342: {
          ...
          break;
            ...
            //
            // Rule 343:  sdcc_function_attribute ::= __naked
            //
            case 343: {
          ...
          break;
            ...
            //
            // Rule 344:  sdcc_function_attribute ::= __shadowregs
            //
            case 344: {
          ...
          break;
            ...
            //
            // Rule 345:  sdcc_function_attribute ::= __wparam
            //
            case 345: {
          ...
          break;
            ...
            //
            // Rule 351:  address_function_attribute ::= __interrupt
            //
            case 351: {
          ...
          break;
            ...
            //
            // Rule 352:  address_function_attribute ::= __using
            //
            case 352: {
