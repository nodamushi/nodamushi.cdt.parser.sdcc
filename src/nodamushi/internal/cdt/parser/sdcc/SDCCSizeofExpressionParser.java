...
public class SDCCSizeofExpressionParser extends PrsStream implements RuleAction, ITokenStream, 
                                                       ITokenCollector, IParser< IASTExpression > 
                                                        , ISecondaryParser< IASTExpression >   
{
    private static ParseTable prs = new SDCCSizeofExpressionParserprs();
    ...
    public SDCCSizeofExpressionParser(LexStream lexStream)
    {
        super(lexStream);

        try
        {
            super.remapTerminalSymbols(orderedTerminalSymbols(), SDCCSizeofExpressionParserprs.EOFT_SYMBOL);
        }
        ...
        catch(UnimplementedTerminalsException e)
        {
            ...
            for (int i = 0; i < unimplemented_symbols.size(); i++)
            {
                ...
                System.out.println("    " + SDCCSizeofExpressionParsersym.orderedTerminalSymbols[id.intValue()]);               
            }
            System.out.println();                        
        }
        catch(UndefinedEofSymbolException e)
        {
            throw new Error(new UndefinedEofSymbolException
                                ("The Lexer does not implement the Eof symbol " +
                                 SDCCSizeofExpressionParsersym.orderedTerminalSymbols[SDCCSizeofExpressionParserprs.EOFT_SYMBOL]));
        } 
    }

    public String[] orderedTerminalSymbols() { return SDCCSizeofExpressionParsersym.orderedTerminalSymbols; }
    public String getTokenKindName(int kind) { return SDCCSizeofExpressionParsersym.orderedTerminalSymbols[kind]; }
    public int getEOFTokenKind() { return SDCCSizeofExpressionParserprs.EOFT_SYMBOL; }
    ...
    public void parser(Monitor monitor, int error_repair_count)
    {
        ...
        catch (NotBacktrackParseTableException e)
        {
            throw new Error(new NotBacktrackParseTableException
                                ("Regenerate SDCCSizeofExpressionParserprs.java with -BACKTRACK option"));
        }
        catch (BadParseSymFileException e)
        {
            throw new Error(new BadParseSymFileException("Bad Parser Symbol File -- SDCCSizeofExpressionParsersym.java"));
        }
...
private  SDCCParserAction  action;
private IASTCompletionNode compNode;


public SDCCSizeofExpressionParser(IScanner scanner, IDOMTokenMap tokenMap, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String,String> properties) {
...
private void initActions(Map<String,String> properties) {
	...
	action = new  SDCCParserAction (this, astStack,  new SDCCASTNodeFactory() ,  SDCCSecondaryParserFactory.getDefault() );
...
public String[] getOrderedTerminalSymbols() {
	return SDCCSizeofExpressionParsersym.orderedTerminalSymbols;
}

@SuppressWarnings("nls")
public String getName() {
	return "SDCCSizeofExpressionParser";
}
...
public void setTokens(List<IToken> tokens) {
	...
	addToken(new Token(null, 0, 0, SDCCSizeofExpressionParsersym.TK_EOF_TOKEN));
}

public SDCCSizeofExpressionParser(ITokenStream stream, Map<String,String> properties) {  // constructor for creating secondary parser
	initActions(properties);
	tokenMap = new TokenMap(SDCCSizeofExpressionParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
}	
    ...
    public void ruleAction(int ruleNumber)
    {
        switch (ruleNumber)
        {
          ...
          break;
            ...
            //
            // Rule 319:  type_qualifier ::= sdcc_type_qualifier
            //
            case 319: {
                  action.  consumeAddressSpaceName();   
          break;
            } 
            //
            // Rule 332:  define_address ::= __at ( absolute_address )
            //
            case 332: {
                  action.   consumeDefineAddress();    
          break;
            } 
            //
            // Rule 333:  define_address ::= __at absolute_address
            //
            case 333: {
                  action.   consumeDefineAddress();    
          break;
            ...
            //
            // Rule 335:  sdcc_type_qualifier ::= __banked
            //
            case 335: {
                  action.   consumeToken();    
          break;
            ...
            //
            // Rule 336:  original_function_direct_declarator ::= basic_direct_declarator ( <openscope-ast> parameter_type_list )
            //
            case 336: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, true);    
          break;
            ...
            //
            // Rule 337:  original_function_direct_declarator ::= basic_direct_declarator ( )
            //
            case 337: {
                  action.   consumeDirectDeclaratorFunctionDeclarator(true, false);    
          break;
            ...
            //
            // Rule 338:  function_direct_declarator ::= original_function_direct_declarator <openscope-ast> sdcc_function_attributes
            //
            case 338: {
                  action.   consumeSDCCFunctionAttributes();    
          break;
            } 
            //
            // Rule 342:  sdcc_function_attribute ::= __critical
            //
            case 342: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__critical,false);    
          break;
            } 
            //
            // Rule 343:  sdcc_function_attribute ::= __reentrant
            //
            case 343: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__reentrant,false);    
          break;
            } 
            //
            // Rule 344:  sdcc_function_attribute ::= __naked
            //
            case 344: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__naked,false);    
          break;
            } 
            //
            // Rule 345:  sdcc_function_attribute ::= __shadowregs
            //
            case 345: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__shadowregs,false);    
          break;
            } 
            //
            // Rule 346:  sdcc_function_attribute ::= __wparam
            //
            case 346: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__wparam,false);    
          break;
            } 
            //
            // Rule 348:  address_function_attribute ::= __interrupt ( constant_expression )
            //
            case 348: {
          ...
          break;
            ...
            //
            // Rule 350:  address_function_attribute ::= __using ( constant_expression )
            //
            case 350: {
          ...
          break;
            ...
            //
            // Rule 352:  address_function_attribute ::= __interrupt
            //
            case 352: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__interrupt,false);    
          break;
            } 
            //
            // Rule 353:  address_function_attribute ::= __using
            //
            case 353: {
                  action.   consumeSDCCFunctionAttribute(SDCCKeyword.__using,false);    
          break;
            } 
            //
            // Rule 354:  integer_token ::= integer
            //
            case 354: {
